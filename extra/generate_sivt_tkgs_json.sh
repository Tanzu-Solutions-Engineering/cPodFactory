...
ssh -o StrictHostKeyChecking=no root@sivt.${NAME_LOWER}.${ROOT_DOMAIN} "arcas --env vsphere --file /opt/vmware/arcas/src/vsphere-dvs-tkgs.json --avi_wcp_configuration --enable_wcp --verbose &" & 
