...
for ($num = 1 ; $num -le 8 ; $num++){
    ...
    Switch ($num){
        1 {$vlanname = $vlanname + "-vsan"}
        2 {$vlanname = $vlanname + "-HOST-TEP"}
        3 {$vlanname = $vlanname + "-EDGE-TEP-TRUNK"}
        4 {$vlanname = $vlanname + "-T0-UPLINK"}
        5 {$vlanname = $vlanname + "-free-01"}
        6 {$vlanname = $vlanname + "-free-02"}
        7 {$vlanname = $vlanname + "-free-03"}
    }
    write-host $vlanname
